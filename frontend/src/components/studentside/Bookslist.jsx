                  ...
                  <Row key={i._id} className="mb-3">
                    <Col md="auto" className="d-flex">
                      ...
                      <div className="ms-3">
                        ...
                        <p className="p-desc">
                          <b>ISBN Number:</b> {i.ISBNNumber}
                          <br />
                          <b>Author Name:</b> {i.authorname}
                          <br />
                          <b>Publisher Name:</b> {i.publishername}
                          <br />
                          <b>Published Date:</b> {i.publisheddate}
                          <br />
                          ...
                          <Form onSubmit={handleSubmit}>
                            ...
                            <input
                              ...
                              name="quantity"
                              onChange={(e) =>
                                setQuantity({ quantity, name: e.target.value })
                              }
                              value={i.quantity}
                            />
                            <b>How many days you borrow?: </b>
                            <input
                              type="number"
                              name="daysborrow"
                              onChange={(e) => setDaysborrow(e.target.value)}
                              style={{ width: "50px" }}
                              min={1}
                              max={9999}
                            />
                            ...
                            <input
                              ...
                              value={makeid(8)}
                            />
                            <CDBBtn color="success" type="submit">
                              Borrow Book
                            </CDBBtn>
                          </Form>
                        </p>
